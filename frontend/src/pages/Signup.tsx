...
import { GitPullRequest, Mail, Lock, User, AlertCircle, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-neutral-100">Create an account</h1>
          <p className="text-sm text-neutral-500 mt-1">Get started with AI Code Review</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-600 mt-1.5">At least 6 characters</p>
          </div>
